    ...
    ext_modules=[
        Extension(
            ...
            ["src/spong/_native.c", "src/c/spong_resolution.c",
             ...
             "src/c/spong_potential.c", "src/c/spong_jet.c",
             "src/c/spong_arrival.c", "src/c/spong_rheostat_gmp.c", "src/c/spong_section.c"],
            depends=["src/spong/_native_rheostat.inc", "src/c/spong_rheostat_pair.inc", "include/spong/spong_rheostat.h", "include/spong/spong_rheostat_pair.h", "include/spong/spong_section.h"],
